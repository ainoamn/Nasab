...
## المرحلة 4 — ترقية لاحقة (مقترحة)

| الأولوية | البند |
|----------|--------|
| عالية | تفعيل `DATABASE_URL` على Vercel (المرحلة 2) |
| عالية | تدوير كلمة مرور الأدمن بعد الإطلاق |
| متوسطة | إصلاح تمرير جسم tRPC على Vercel أو الإبقاء على مسارات Hono للحساسة |
| متوسطة | نسخ احتياطي Neon مجدول |
| منخفضة | نطاق مخصص + بريد معاملاتي |
