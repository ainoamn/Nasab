...
| الأولوية | البند |
|----------|--------|
| عالية | تدوير كلمة مرور المشرف بعد أول دخول ناجح |
| عالية | إنشاء شجرة تجريبية والتحقق من الحفظ على الإنتاج |
| متوسطة | نسخ Neon مجدول (GitHub Action أو Neon branching) |
| متوسطة | نطاق مخصص + شهادة HTTPS |
| منخفضة | بريد معاملاتي للدعوات |
